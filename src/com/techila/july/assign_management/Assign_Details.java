...
import com.techila.july.assign_management.adapter.CustomAdapterAdminListView;
...
public class Assign_Details extends ListActivity {
	...
	CustomAdapterAdminListView adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (mMyPreferences.getPreference("Context").equals("Assignee")) {
			...
			adapter = new CustomAdapterAdminListView(this, AssignmentList);
